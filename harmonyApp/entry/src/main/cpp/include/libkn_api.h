...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_compose_sample_SqlDelightTest;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_compose_sample_SqlDelightTestRunner;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_compose_sample_SqlDelightTestSuite;
typedef struct {
  libkn_KNativePtr pinned;
...
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_compose_sample_DatabaseConfig;
typedef struct {
  libkn_KNativePtr pinned;
} libkn_kref_com_tencent_compose_sample_DatabaseManager;
        ...
        struct {
          struct {
            ...
            struct {
              ...
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_SqlDelightTest (*SqlDelightTest)();
                libkn_kref_com_tencent_compose_sample_DatabaseHelper (*get_dbHelper)(libkn_kref_com_tencent_compose_sample_SqlDelightTest thiz);
                void (*set_dbHelper)(libkn_kref_com_tencent_compose_sample_SqlDelightTest thiz, libkn_kref_com_tencent_compose_sample_DatabaseHelper set);
                void (*testDeleteAll)(libkn_kref_com_tencent_compose_sample_SqlDelightTest thiz);
                void (*testInsertAndSelect)(libkn_kref_com_tencent_compose_sample_SqlDelightTest thiz);
                void (*testUpdateAndDelete)(libkn_kref_com_tencent_compose_sample_SqlDelightTest thiz);
              } SqlDelightTest;
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_SqlDelightTestRunner (*SqlDelightTestRunner)();
                void (*runAllTests)(libkn_kref_com_tencent_compose_sample_SqlDelightTestRunner thiz);
              } SqlDelightTestRunner;
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_SqlDelightTestSuite (*SqlDelightTestSuite)();
                void (*testConcurrentOperations)(libkn_kref_com_tencent_compose_sample_SqlDelightTestSuite thiz);
                void (*testDatabaseOperations)(libkn_kref_com_tencent_compose_sample_SqlDelightTestSuite thiz);
                void (*testEdgeCases)(libkn_kref_com_tencent_compose_sample_SqlDelightTestSuite thiz);
              } SqlDelightTestSuite;
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_WebViewTest (*WebViewTest)();
                const char* (*runAllTests)(libkn_kref_com_tencent_compose_sample_WebViewTest thiz);
                const char* (*testWebViewInitialization)(libkn_kref_com_tencent_compose_sample_WebViewTest thiz);
                const char* (*testWebViewJavaScript)(libkn_kref_com_tencent_compose_sample_WebViewTest thiz);
                const char* (*testWebViewLoading)(libkn_kref_com_tencent_compose_sample_WebViewTest thiz);
                const char* (*testWebViewNavigation)(libkn_kref_com_tencent_compose_sample_WebViewTest thiz);
              } WebViewTest;
              struct {
                struct {
                  libkn_KType* (*_type)(void);
              ...
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_DatabaseConfig (*DatabaseConfig)();
                libkn_kref_app_cash_sqldelight_db_SqlDriver (*createDriver)(libkn_kref_com_tencent_compose_sample_DatabaseConfig thiz, const char* databaseName);
              } DatabaseConfig;
              struct {
                libkn_KType* (*_type)(void);
                libkn_kref_com_tencent_compose_sample_DatabaseManager (*_instance)();
                void (*close)(libkn_kref_com_tencent_compose_sample_DatabaseManager thiz);
                libkn_kref_com_tencent_compose_db_MyDatabase (*getDatabase)(libkn_kref_com_tencent_compose_sample_DatabaseManager thiz);
                libkn_KBoolean (*initialize)(libkn_kref_com_tencent_compose_sample_DatabaseManager thiz);
              } DatabaseManager;
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter__)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter__)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter___)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter___)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter____)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_____)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_____)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter______)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_______)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_______)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter__________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter__________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter___________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter___________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter____________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter____________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_____________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_____________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_____________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_____________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_____________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_____________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_____________)();
              ...
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_______________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter__________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter___________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter____________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter____________________)();
              libkn_kref_app_cash_sqldelight_db_SqlDriver (*createTestDriver)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseConfig$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseHelper$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_DatabaseManager$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_KsoupTest$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_Person$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_Person_$serializer$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTest$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestRunner$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_SqlDelightTestSuite$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_WebViewTest$stableprop_getter_____________________)();
              libkn_KInt (*com_tencent_compose_sample_XmlUtilTest$stableprop_getter_____________________)();
            } sample;
